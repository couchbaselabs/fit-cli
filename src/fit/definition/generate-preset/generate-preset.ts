...
async function loadPresetMap(): Promise<Record<string, string>> {
  ...
  return {
    ...
    "op-capella-pe-sit-release-current":  ((await import("../../../../presets/op-capella-pe-sit-release-current.json5",  { with: { type: "text" } })) as { default: string }).default,
    "op-capella-pe-sit-release-previous": ((await import("../../../../presets/op-capella-pe-sit-release-previous.json5", { with: { type: "text" } })) as { default: string }).default,
