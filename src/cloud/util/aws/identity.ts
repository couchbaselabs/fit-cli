...
function printAwsProfileSummary(profiles: AwsProfilesInfo): void {
  ...
  console.log("  'fit-cli-role' can only be assumed from specific repos (for CI) and the cb-sdk AWS account (958525475024, for local testing).");
  console.log("  E.g. you must be on that account for local testing: if not, create an IT ticket.");
